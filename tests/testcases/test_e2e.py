...
from milvus_dataset import ConfigManager, list_datasets, load_dataset
...
schema = CollectionSchema(
    fields=[id_field, vector_field, text_field], description="我的数据集schema"
)


class TestMilvusDatasetE2E:
    def test_list_datasets(self):
        load_dataset("test_dataset", schema=schema)
